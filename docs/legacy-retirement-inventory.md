...
| Flat compatibility routing | `src/docs/application/flat_pipeline_compatibility.py` | Remove | Native document/source commands |
...
| Legacy final promotion | `src/docs/cli/commands/doc_app.py` `mark-final` | Remove | `document publish` |
...
| Migration documentation | `docs/migration-v2.md`, compatibility sections | Rewrite/remove | Canonical v2 workflow |
