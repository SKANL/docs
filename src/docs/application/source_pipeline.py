...
def strict_policy_error(policy: Any, invocation_strict: bool) -> str | None:
    """Validate the source pipeline's explicit strict-policy evidence."""
...
class SourcePipeline:
    """Coordinate source stages without changing the alternate pipeline."""
    ...
    def _report(
        ...
        succeeded = SourcePipeline._result_succeeded(result)
        report = {
            "schema": "docs.sources/v2",
            "document_id": document_id,
            "succeeded": True,
